package("nazaraengine")
    ...
    add_versions("2026.09.07+1", "a72644cc161b0fdd9e8d03196d846323a58c2d3a")
    ...
    local components = {
        ...
        physics3d = {
            ...
            deps = { "core" },
            custom = function (package)
                package:add("deps", "joltphysics v5.6.0", {private = true, configs = {debug = package:is_debug()}})
            end
        },
        platform = {
            option = "platform",
